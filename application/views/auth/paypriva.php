...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$date = date("h:i:sa");
        ...
        'day' => $this->input->post('day')
		  ...
		  $this->db->insert('pay_private',$data);
...
<body>
	...
	$id = $_GET['id'];
	$hasil = $this->db->query("SELECT * FROM private WHERE id='$id'"); 
	foreach($hasil->result_array() as $d){
        ?>
        <input type="text" class="form-control" id="day" name="day" value="<?= $d['day'];?>" hidden>
    <label for="email" class="col-sm-2 col-form-label">Class Name</label>
  ...
  <label for="email" class="col-sm-2 col-form-label">Start</label>
      <input type="text" class="form-control" id="start_hours" name="start_hours" value="<?= $d['start_hours'];?>"readonly>
  <label for="email" class="col-sm-2 col-form-label">End</label>
      <input type="text" class="form-control" id="end_hours" name="end_hours" value="<?= $d['end_hours'];?>"readonly>
...
<label class="container"><a class="login100-social-item">
  ...
  <span class="checkmark"></span>
				...
				<div class="container-login100-form-btn">
					<a class="login100-form-btn" href="<?= base_url('Paypriva/back')?>" data-toggle="modal" data-target="#logoutModal">Back</a>
				</div>
				<br>
<!-- </form> -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?= base_url('Paypriva/back')?>">Back</a>
        </div>
      </div>
    </div>
  </div>
