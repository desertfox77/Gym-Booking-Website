      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Tuesday</h1>
        ...
        <?php 
        foreach($sherrile->result_array() as $pie) : ?>
            <div class="row-wrap">
              <div class="row bg-white p-4 align-items-center">
                ...
                <div class="col-sm-3 col-md-3 col-lg-2 text-md-right"><a href="http://localhost/mainhome/Paypriva?id=<?php echo $pie['id']; ?>" class="btn btn-primary pill px-4 mt-3 mt-md-0">Join Now</a></div>     
              </div>
            </div>
            <?php endforeach ?>
